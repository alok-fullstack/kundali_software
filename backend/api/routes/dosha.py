        ...
        return {
            ...
            "dosha_analysis": {
                ...
                "manglik": {
                    ...
                    "mars_house": result.manglik_dosha.additional_info.get('mars_from_lagna') if result.manglik_dosha.additional_info else None,
                    "mars_from_lagna": result.manglik_dosha.additional_info.get('mars_from_lagna') if result.manglik_dosha.additional_info else None,
                    "mars_from_moon": result.manglik_dosha.additional_info.get('mars_from_moon') if result.manglik_dosha.additional_info else None,
                    "mars_from_venus": result.manglik_dosha.additional_info.get('mars_from_venus') if result.manglik_dosha.additional_info else None,
                    "is_manglik_from_lagna": result.manglik_dosha.additional_info.get('is_manglik_from_lagna') if result.manglik_dosha.additional_info else False,
                    "is_manglik_from_moon": result.manglik_dosha.additional_info.get('is_manglik_from_moon') if result.manglik_dosha.additional_info else False,
                    "is_manglik_from_venus": result.manglik_dosha.additional_info.get('is_manglik_from_venus') if result.manglik_dosha.additional_info else False,
